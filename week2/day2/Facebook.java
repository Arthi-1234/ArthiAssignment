...
public class Facebook {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//div[@class='mbm _1iy_ _a4y _3-90 lfloat _ohe']//input[@name='firstname']")).sendKeys("Arthitest123");
		//2 - Elder Sibling to Younger sibling + Partial text based
		driver.findElement(By.xpath("//div[contains(text(),'Sur')]//following-sibling::input[@name='lastname']")).sendKeys("Sankar");
		//3 - Parent to Child
		driver.findElement(By.xpath("//div[@class='uiStickyPlaceholderInput uiStickyPlaceholderEmptyInput']/input[@name='reg_email__']")).sendKeys("9894772270");
