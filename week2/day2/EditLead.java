...
public class EditLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.xpath("//div[@class='x-form-item x-tab-item']//input[@name='firstName']")).sendKeys("Arthi");
		...
		driver.findElement(By.id("updateLeadForm_companyName")).sendKeys("Lenovo");
