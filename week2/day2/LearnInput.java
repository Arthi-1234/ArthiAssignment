...
public class LearnInput {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='col-12']/input[@name='j_idt88:name']")).sendKeys("Arthi");
		...
		driver.findElement(By.xpath("//div[@class='col-12']/input[@name='j_idt88:j_idt99']")).sendKeys("arthi.san87@gmail.com",Keys.TAB);
		driver.findElement(By.xpath("//div[@class='col-12']/textarea[@name='j_idt88:j_idt101']")).sendKeys("This is Arthi, so excited to learn Selenium");
